...
namespace UnitTestProject
{
    ...
    public class UnitTest1
    {
        ...
        {
            Assert.AreEqual(expected.m1, actual.m1, tolerance);
            Assert.AreEqual(expected.m2, actual.m2, tolerance);
            Assert.AreEqual(expected.m3, actual.m3, tolerance);
            Assert.AreEqual(expected.m4, actual.m4, tolerance);
            Assert.AreEqual(expected.m5, actual.m5, tolerance);
            Assert.AreEqual(expected.m6, actual.m6, tolerance);
            Assert.AreEqual(expected.m7, actual.m7, tolerance);
            Assert.AreEqual(expected.m8, actual.m8, tolerance);
            Assert.AreEqual(expected.m9, actual.m9, tolerance);
        }
        ...
        static void AreComparable(Matrix4 expected, Matrix4 actual, float tolerance = DEFAULT_TOLERANCE)
        {
            ...
            Assert.AreEqual(expected.m14, actual.m14, tolerance);
            Assert.AreEqual(expected.m15, actual.m15, tolerance);
            Assert.AreEqual(expected.m16, actual.m16, tolerance);
        }
        ...
        {
            Assert.AreEqual(expected.m1, actual.m1);
            Assert.AreEqual(expected.m2, actual.m2);
            Assert.AreEqual(expected.m3, actual.m3);
            Assert.AreEqual(expected.m4, actual.m4);
            Assert.AreEqual(expected.m5, actual.m5);
            Assert.AreEqual(expected.m6, actual.m6);
            Assert.AreEqual(expected.m7, actual.m7);
            Assert.AreEqual(expected.m8, actual.m8);
            Assert.AreEqual(expected.m9, actual.m9);
        }
        static void AreEqual(Matrix4 expected, Matrix4 actual)
        {
            ...
            Assert.AreEqual(expected.m14, actual.m14);
            Assert.AreEqual(expected.m15, actual.m15);
            Assert.AreEqual(expected.m16, actual.m16);
        }
        ...
        public void Matrix3Construction()
        {
            ...
            Matrix3 m3a = new Matrix3(expected.m1, expected.m2, expected.m3,
                                      expected.m4, expected.m5, expected.m6,
                                      expected.m7, expected.m8, expected.m9);
        ...
        public void Matrix4Construction()
        {
            ...
            Matrix4 m3a = new Matrix4(expected.m1, expected.m2, expected.m3, expected.m4,
                                      expected.m5, expected.m6, expected.m7, expected.m8,
                                      expected.m9, expected.m10, expected.m11, expected.m12,
                                      expected.m13, expected.m14, expected.m15, expected.m16);
        ...
        public void Matrix3MultiplyRotationTranslation()
        {
            ...
            rotateBy90.RotateZ((float)Math.PI / 2.0f);
